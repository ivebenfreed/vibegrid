...
import type { RelationshipContext, RelationshipOptionsProvider } from '../types'
 ...
 * - Sorted by sortOrder
 */
export const statusDefinitionProvider: RelationshipOptionsProvider = async (
  context: RelationshipContext,
) => {
  fileLog.warn(
    '⚠️ DEPRECATED: Atom-based status definition provider called. VibeGrid uses Dexie providers.',
  )
  return []
}
