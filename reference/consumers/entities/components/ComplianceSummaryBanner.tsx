  ...
  const counts: ComplianceCounts = useMemo(() => {
    ...
    for (const row of rows) {
      ...
      if (check.status === 'pass') {
        ...
        // Check whether the cert is expiring within 30 days (computed_formula from compliance object)
        const expiryRaw = record.earliest_expiration as string | null | undefined
