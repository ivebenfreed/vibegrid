/**
 * Mock VibeGrid Basic Test Route
 *
 * Test route for VibeGrid with mock data - no API calls required.
 * Useful for testing grid features in isolation.
 *
...
/**
 * Main component for basic VibeGrid testing with mock data
 */
function MockVibeGridBasic() {
  ...
  return (
    <>
      <Header>
        <h1 className="text-xl font-semibold">VibeGrid Test - Basic</h1>
      </Header>
      <Main fluid>
