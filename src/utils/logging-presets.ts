...
export const VIBEGRID_LOG_PRESETS = {
  ...
  debugOverlays() {
    if (typeof window !== 'undefined' && (window as any).__BASEPLANE_LOGGER__) {
      ;(window as any).__BASEPLANE_LOGGER__.setLevel('warning', ['vibegrid'])
      ;(window as any).__BASEPLANE_LOGGER__.setLevel('debug', ['vibegrid', 'overlays'])
  ...
  debugCoordinates() {
    if (typeof window !== 'undefined' && (window as any).__BASEPLANE_LOGGER__) {
      ;(window as any).__BASEPLANE_LOGGER__.setLevel('warning', ['vibegrid'])
      ;(window as any).__BASEPLANE_LOGGER__.setLevel('debug', ['vibegrid', 'coordinates'])
  ...
  debugMouse() {
    if (typeof window !== 'undefined' && (window as any).__BASEPLANE_LOGGER__) {
      ;(window as any).__BASEPLANE_LOGGER__.setLevel('warning', ['vibegrid'])
      ;(window as any).__BASEPLANE_LOGGER__.setLevel('debug', ['vibegrid', 'mouse'])
  ...
  debugEditors() {
    if (typeof window !== 'undefined' && (window as any).__BASEPLANE_LOGGER__) {
      ;(window as any).__BASEPLANE_LOGGER__.setLevel('warning', ['vibegrid'])
      ;(window as any).__BASEPLANE_LOGGER__.setLevel('debug', ['vibegrid', 'editors'])
